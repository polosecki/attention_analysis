function [linehandle,curent_yarange]=paper_grand_psth_plot(grand_psth,this_plot_trials,surf_str_extra,plot_params)
...
if isfield(plot_params, 'linestyle') && ~isempty(plot_params.linestyle)
    set(linehandle,'LineStyle',plot_params.linestyle)
end
plot_lines=false;
if plot_params.align==1
    if plot_lines
