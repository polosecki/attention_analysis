...
%[results]=make_GLM_fun(cell_no,monkey,area,'time_course',0,0);
[results]=make_GLM_fun(cell_no,monkey,area,'betas_for_pca',0,0);
...
%  logical([0 0 0 0 0 0 0 0 0])};
    ...
    true_contrasts=[1 1;
                     ...
                     2 7];  
close all
f=plot_GLM_contrasts_for_presentation(results,true_contrasts,0);
for i=1:length(f)
    ...
    saveas(f(i),fullfile(figure_dir,[filename '_part_' num2str(i) '.eps']),'epsc');
