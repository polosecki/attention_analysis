...
%cell_file=fullfile(cell_file_dir,[area '_' monkey '.mat']);
%load(fullfile(cell_file));
load('/Freiwald/ppolosecki/lspace/michel/150611Quincy - MULTIELrec/proc/150611Quimcy_multiel0017.mat');
ifname=fullfile('/Freiwald/ppolosecki/lspace/michel/150611Quincy - MULTIELrec/proc/150611_quincy_2electrodes019001_r.dh5');
overwrite_grand_psth=true;
use_BRT_trigger=false;%false;%true;%
bid = 1; % Channel number (1 for Blackrock recordings in Freiwald lab)
clussel =1; % Cluster number(s)
end
...
if make_grand_psth
    if overwrite_grand_psth || ~exist(fullfile(base_dir,cell_str(cell_no).dir,'proc',['cell_' sprintf('%03.0f',cell_no) '_single_trial_attn_PSTH.mat']),'file')
